...
void Menu::initialise()
{
    ...
    g_game_state.map = new Map(LEVEL0_WIDTH, LEVEL0_HEIGHT, LEVEL_0_DATA, map_texture_id, 1.0f, 25, 24);
...
void Menu::render(ShaderProgram *program)
{
    ...
    Utility::draw_text(program, text_texture_id, "PRESS ENTER TO START THE GAME", 0.5f, -0.1f, glm::vec3(2.0f,-2.0f, 0.0f));
