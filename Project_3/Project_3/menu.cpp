...
void Menu::render(ShaderProgram *program)
{
    ...
    Utility::draw_text(program, text_texture_id, "Clear all the spiders", 0.5f, -0.1f, glm::vec3(1.0f,-2.0f, 0.0f));
    Utility::draw_text(program, text_texture_id, "Press enter to start", 0.5f, -0.1f, glm::vec3(1.0f,-3.0f, 0.0f));
